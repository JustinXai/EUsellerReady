...
export const homepageFAQs: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      'Shopify sellers preparing to sell to EU consumers may need to review GPSR product safety topics, EU Responsible Person topics, and EPR packaging topics in relevant EU countries such as Germany and France.',
  },
  {
...
export const amazonEprFAQs: FAQItem[] = [
  ...
  { question: 'Why do Germany and France matter for EPR?', answer: 'Germany and France are the two most active EU markets for EPR packaging regulation. Germany may require sellers to review LUCID packaging register topics depending on their setup. France has its own EPR system with accredited compliance schemes. Many Amazon sellers start with these two markets when reviewing EPR topics. Platform requirements may also reference EPR registration topics in these countries.' },
  ...
  { question: 'Is EPR the same as GPSR?', answer: 'No. EPR (Extended Producer Responsibility) and GPSR (General Product Safety Regulation) are different regulations. EPR covers packaging waste and environmental recovery topics at the country level. GPSR covers product safety, traceability, manufacturer information and EU Responsible Person topics. Both may be relevant for Amazon sellers, but they address different compliance topics.' },
  { question: 'Should I use an EPR provider?', answer: 'EPR registration can involve country-specific processes, reporting topics and periodic fees. Many sellers use a compliance service provider to handle registration and reporting in multiple countries. If you sell in multiple EU markets, a provider may help manage EPR topics across different schemes.' },
  { question: 'Is this legal advice?', answer: 'No. This page provides educational guidance and identifies topics to review. It does not constitute legal advice or a compliance determination. Consult qualified legal counsel or a compliance provider for your specific situation.' },
];
