...
export const routes: Route[] = [
  ...
  },
  {
    ...
    title: 'GPSR Guide for Ecommerce Sellers',
    description: 'A practical GPSR guide for ecommerce sellers reviewing EU Responsible Person, product safety information, platform requirements and provider help before selling to EU consumers.',
    h1: 'GPSR Guide for Ecommerce Sellers',
    category: 'platform-guide',
    priority: '0.85',
    changefreq: 'weekly',
    includeInSitemap: true,
  ...
  },
  {
    ...
    title: 'GPSR Compliance for DTC Brands',
    description: 'A practical GPSR guide for DTC brands reviewing EU Responsible Person, product safety information, labels, packaging and store product pages before selling to EU consumers.',
    h1: 'GPSR Compliance for DTC Brands',
    category: 'platform-guide',
    priority: '0.8',
    changefreq: 'weekly',
    includeInSitemap: true,
